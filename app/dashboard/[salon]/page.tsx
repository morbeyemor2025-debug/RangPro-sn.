    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .salon-badge {
          background: rgba(186,122,43,0.15);
          border: 1px solid rgba(186,122,43,0.25);
          color: #f4b23f;
          font-size: 11px;
          padding: 3px 10px;
          border-radius: 100px;
        ...
        @keyframes pulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(15,143,100,0.4); }
          50% { box-shadow: 0 0 0 6px rgba(15,143,100,0); }
        }
        ...
        .call-next-btn {
          width: 100%;
          background: linear-gradient(135deg, #ba7a2b, #f4b23f);
          color: #0a0a0a;
          border: none;
          border-radius: 14px;
          padding: 18px;
        ...
        .call-next-btn:hover {
          ...
          box-shadow: 0 12px 32px rgba(186,122,43,0.4);
        }
        ...
        .ticket-card.called {
          ...
          background: rgba(15,143,100,0.05);
        }
        ...
        .status-waiting {
          background: rgba(186,122,43,0.12);
          color: #f4b23f;
          border: 1px solid rgba(186,122,43,0.25);
        }
        ...
        .status-called {
          ...
          color: #0f8f64;
          border: 1px solid rgba(15,143,100,0.3);
          animation: pulse 2s infinite;
        }
        ...
        .btn-call {
          background: rgba(186,122,43,0.15);
          color: #f4b23f;
          border: 1px solid rgba(186,122,43,0.3);
        }

        .btn-call:hover:not(:disabled) {
          background: rgba(186,122,43,0.25);
        }

        .btn-serve {
          background: rgba(15,143,100,0.15);
          color: #0f8f64;
          border: 1px solid rgba(15,143,100,0.3);
        }

        .btn-serve:hover:not(:disabled) {
          background: rgba(15,143,100,0.25);
        }

        .btn-cancel {
          background: rgba(220,87,80,0.1);
          color: #dc5750;
          border: 1px solid rgba(220,87,80,0.2);
        }

        .btn-cancel:hover:not(:disabled) {
          background: rgba(220,87,80,0.2);
        }
        ...
        .toggle-active {
          background: rgba(15,143,100,0.12);
          border-color: rgba(15,143,100,0.3);
          color: #0f8f64;
        }

        .toggle-inactive {
          background: rgba(220,87,80,0.08);
          border-color: rgba(220,87,80,0.2);
          color: #dc5750;
        }
        ...
        @media (max-width: 600px) {
          ...
          .ticket-actions { flex-direction: column; gap: 4px; }
            ...
            {tickets.length === 0 ? (
              ...
              <div className="ticket-list">
                {tickets.map((ticket) => (
                  ...
                  >
                    <div className="ticket-num-badge">
                    ...
                    <div className="ticket-actions">
                      ...
                      {ticket.status === "called" && (
                        <button
                          ...
                          onClick={() =>
                            markServed(ticket.id, ticket.barber_id)
                          }
                  ...
                  <div key={barber.id} className="barber-card">
                    ...
                    <div>
                      ...
                      <div className="barber-current">
                        {barber.current_ticket
                          ? `Ticket #${barber.current_ticket}`
                          : "Disponible"}
                      </div>
                    </div>
                    <button
                      className={`toggle-btn ${
                        barber.is_active ? "toggle-active" : "toggle-inactive"
                      }`}
