...
export default function JoinPage({ params }: Props) {
  ...
  useEffect(() => {
    if (myTicket?.id) {
      const unsub = subscribeToTicket(myTicket.id);
      return unsub;
    }
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card {
          ...
          width: 100%;
          max-width: 420px;
          box-shadow: 0 40px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(186,122,43,0.1);
        ...
        .btn-primary:hover {
          ...
          box-shadow: 0 8px 24px rgba(186,122,43,0.4);
        }
        ...
        .ticket-number {
          ...
          text-align: center;
          margin: 16px 0;
          text-shadow: 0 0 60px rgba(186,122,43,0.3);
        }
        ...
        .status-called {
          ...
          border: 1px solid rgba(15,143,100,0.4);
          color: #0f8f64;
        ...
        @keyframes pulse {
          ...
          50% { box-shadow: 0 0 0 8px rgba(15,143,100,0); }
        }
        ...
        .called-banner {
          background: linear-gradient(135deg, rgba(15,143,100,0.2), rgba(15,143,100,0.05));
        ...
        <div className="card">
          ...
          {step === "welcome" && (
            <>
              ...
              {salon?.address && (
                <p className="salon-sub">📍 {salon.address}</p>
              )}
            ...
            <>
              ...
              {myTicket.barber_id && (
                <div className="info-row">
                  <span>Coiffeur</span>
                  <span>
                    {barbers.find((b) => b.id === myTicket.barber_id)?.name ??
                      "—"}
                  </span>
                </div>
              )}
